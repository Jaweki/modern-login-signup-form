...
const MainCard = () => {
  ...
  return (
    <>
      <div className="w-[65%] h-[65%] rounded-xl bg-white flex relative max-tablet:hidden">
        <InputForm action={action} />
        <InfoBanner action={action} setAction={setAction} />
      </div>
      <div className="w-[95%] h-[93%] rounded-xl bg-white flex flex-col relative tablet:hidden gap-3">
